...
async function initDb() {
  await pool.query(`
    ...
    -- and every Sale Return. These mirrored the invoice and don't exist in Busy. Safe to re-run.
    DELETE FROM payments WHERE notes IN ('Auto from Busy import', 'Auto-refund from Busy sale return');
